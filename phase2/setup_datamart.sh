...
# Creating the Data Mart using PostgreSQL
...
# In this bash file, only the first 50 rows of each table in the are selected 
# and outputted.
...
SELECT * FROM branch_attendance_outrigger_dimension;
...
SELECT * FROM review_text_dimension LIMIT 50;

EOF

psql reviewsDM <<EOF

SELECT * FROM review_fact LIMIT 50;
